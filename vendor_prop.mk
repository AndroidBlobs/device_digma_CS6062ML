PRODUCT_PROPERTY_OVERRIDES +=  \
    ...
    qemu.hw.mainkeys=0 \
    ril.read.imsi=1 \
    ro.build.display.id=P5CFFC.YBT.S651B1CITI653.RU.HB.HJ.STAJHYAHTA.1119.V3.01 \
    ...
    ro.camera_max_brightness=0 \
    ro.carrier=unknown \
    ro.com.google.acsa=true \
    ro.com.google.clientidbase=android-coosea \
    ro.config.alarm_alert=Alarm_Lights.ogg \
    ro.config.notification2_sound=prize_noti_default.ogg \
    ro.config.notification_sound=prize_noti_default.ogg \
    ro.config.ringtone2=Safari.ogg \
    ro.config.ringtone=Safari.ogg \
    ro.control_privapp_permissions=log \
    ro.crypto.volume.filenames_mode=aes-256-cts \
    ro.dalvik.vm.native.bridge=0 \
    ro.email_support_ucs2=0 \
    ro.fingerprint_function=1 \
    ro.flashlight_disable_level=0 \
    ...
    ro.pcba_oversea_customer=yibotong \
    ro.pri.ai.scene=1 \
    ro.pri.bangs.screen=0 \
    ro.pri.charging_sound=1 \
    ro.pri.charging_tips=1 \
    ro.pri.current.project=0 \
    ro.pri.custom_imei_display=1 \
    ro.pri.faceid=1 \
    ro.pri.fingerprint=sw_tee_none_android9 \
    ro.pri.flash.front=1 \
    ro.pri.front.mirror=1 \
    ro.pri.light.style=light \
    ro.pri.mode.plugin=1 \
    ro.pri.nightshot.arcsoft=1 \
    ro.pri.picturezoom.pictureize=11328x8496 \
    ro.pri.portrait.mode=1 \
    ro.pri.professional.mode=1 \
    ro.pri.selfie.arcsoft=1 \
    ro.pri.settings.newstyle=1 \
    ro.pri.simulate.dual.camera.tip=1 \
    ro.pri.statusbar.light.theme=1 \
    ro.pri.storagepath.default.value=phone \
    ro.pri.superzoom.arcsoft=1 \
    ro.pri.video.focus.mode=0 \
    ro.pri.yuv_back_value1=200 \
    ro.pri.yuv_back_value=800 \
    ro.pri.yuv_front_value=150 \
    ro.pri_accelerometer_rotation=1 \
    ro.pri_add_thumbnail_fileman=0 \
    ro.pri_apn_order_name_desc=0 \
    ro.pri_app_cell_height=1 \
    ro.pri_ar_layout_ltr=0 \
    ro.pri_auto_time=1 \
    ro.pri_auto_time_zone=1 \
    ro.pri_autoimei=1 \
    ro.pri_back_at_left_pos_def=1 \
    ro.pri_back_default_flash=auto \
    ro.pri_battery_capacity=4000 \
    ro.pri_bg_power_saving_enable=1 \
    ro.pri_bluetooth=1 \
    ro.pri_board_network_type=LfB/LtB/WB/GB \
    ro.pri_brightness_mode=0 \
    ro.pri_browser_homepage=chrome-native://newtab \
    ro.pri_browser_yahoo_bookmarks_support=0 \
    ro.pri_calendar_monday_sort=0 \
    ro.pri_cam_vfb=1 \
    ro.pri_camera_fn_facebeauty=1 \
    ro.pri_changed_wallpaper=1 \
    ro.pri_cts=1 \
    ro.pri_customer=pcba-sea \
    ro.pri_customer_logo_icon=0 \
    ro.pri_def_development_settings=0 \
    ro.pri_def_emergency_tone=0 \
    ro.pri_def_front_mode_normal=1 \
    ro.pri_default_theme_path=system/media/config/theme/default/default.jar \
    ro.pri_default_value_changed_wallpaper=0 \
    ro.pri_default_value_flip_silent=0 \
    ro.pri_default_value_show_battery_percent=0 \
    ro.pri_default_value_smart_answer_call=0 \
    ro.pri_default_value_wireless_charger=1 \
    ro.pri_del_lan_switch_btn=1 \
    ro.pri_del_settings_ges_dc=0 \
    ro.pri_dialer_tab_index=0 \
    ro.pri_dialpad_always_show=1 \
    ro.pri_doujia_dog_free=1 \
    ro.pri_dtmf_tone_when_dialing=1 \
    ro.pri_factory_calibration01=0 \
    ro.pri_factory_default_lang_en=0 \
    ro.pri_factory_test=1 \
    ro.pri_factory_test_wbg=0 \
    ro.pri_fast_charge=1 \
    ro.pri_flash_diff_led=0 \
    ro.pri_flip_silent=1 \
    ro.pri_fm_usb=1 \
    ro.pri_font_size=1.0 \
    ro.pri_fp_answer_call=0 \
    ro.pri_fp_music_player=0 \
    ro.pri_fp_return_back=0 \
    ro.pri_fp_return_home=0 \
    ro.pri_fp_screen_capture=0 \
    ro.pri_fp_slide_launcher=0 \
    ro.pri_fp_take_photo=0 \
    ro.pri_fp_video_player=0 \
    ro.pri_gallery_magnify=2 \
    ro.pri_gester_camera=1 \
    ro.pri_gesture_navigation=1 \
    ro.pri_gesture_navigation_response_value=14 \
    ro.pri_gms_fastpass_plus=0 \
    ro.pri_gms_russia=1 \
    ro.pri_gsensor_call_lf_screen=0 \
    ro.pri_imei_length=14 \
    ro.pri_increase_navbar_sensitivity=0 \
    ro.pri_intercept_wakeup_alarm=1 \
    ro.pri_is_language_adp_sim=1 \
    ro.pri_isdel_ZenModePriority=0 \
    ro.pri_isdel_simprocessor_notify=1 \
    ro.pri_isdelete_security_update=0 \
    ro.pri_isshow_fontsize=1 \
    ro.pri_isshow_fontstyle=0 \
    ro.pri_keyguard_charge_anim=1 \
    ro.pri_language_change_progress=1 \
    ro.pri_launcher_singleanddouble=1 \
    ro.pri_launcher_translucent=1 \
    ro.pri_led_switch_support=0 \
    ro.pri_lockscreen_sounds=1 \
    ro.pri_long_camera_key=0 \
    ro.pri_mmsreceiver_wakeup=1 \
    ro.pri_mobile_data_def_on=1 \
    ro.pri_navba_style=0 \
    ro.pri_navbar_height=48 \
    ro.pri_number_min_match=7 \
    ro.pri_otg=1 \
    ro.pri_ownerinfo_maxlen=200 \
    ro.pri_preload_local_bookmark_suport=0 \
    ro.pri_qs_theme=0 \
    ro.pri_recent_used_menu=0 \
    ro.pri_regaltory_legal=0 \
    ro.pri_remove_app_icon_background=0 \
    ro.pri_remove_full_charge_item=1 \
    ro.pri_screen_brightness=206 \
    ro.pri_screen_off_timeout=60000 \
    ro.pri_setting_storage_avai=0 \
    ro.pri_settings_elastic=1 \
    ro.pri_short_camera_key=1 \
    ro.pri_show_battery_remaininglable=0 \
    ro.pri_show_device_memory=0 \
    ro.pri_show_device_storage=0 \
    ro.pri_show_main_camera=0 \
    ro.pri_show_screen_resolution=0 \
    ro.pri_show_screen_size=0 \
    ro.pri_show_sub_camera=0 \
    ro.pri_show_user_guide=0 \
    ro.pri_shutdown_animation_play_time=12 \
    ro.pri_signal_icon=1 \
    ro.pri_sim_preferred=1 \
    ro.pri_slide_screenshot=1 \
    ro.pri_smart_answer_call=1 \
    ro.pri_sms_to_mms_threshold=3 \
    ro.pri_stream_accessibility=11 \
    ro.pri_stream_alarm=12 \
    ro.pri_stream_bluetooth_sco=7 \
    ro.pri_stream_dtmf=11 \
    ro.pri_stream_music=8 \
    ro.pri_stream_notification=8 \
    ro.pri_stream_ring=12 \
    ro.pri_stream_system=15 \
    ro.pri_stream_system_enforced=15 \
    ro.pri_stream_tts=11 \
    ro.pri_stream_voice_call=4 \
    ro.pri_tee=2 \
    ro.pri_time_12_24=24 \
    ro.pri_touch_sounds=0 \
    ro.pri_use_camera_low_battery=0 \
    ro.pri_vibrate_on_touch=1 \
    ro.pri_vibrate_when_ringing=0 \
    ro.pri_wifi=1 \
    ro.pri_wifi_call=1 \
    ro.prisw.dualcard.ringtone=1 \
    ro.sf.hwrotation=0 \
    ...
    ro.vendor.mediatek.version.release=alps-mp-p0.mp7-V2.51_prize.p0mp7.k57pv1.dm.64_P4 \
    ...
    ro.vendor.prize_powerkey_snooze=1 \
